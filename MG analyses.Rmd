...
##3poly
###Data management
mg.fall2017.6month.den.Poly3 <- subset(mg.fall2017.6month.den, identity == "Niles" | identity == "Poly 3" | identity == "West" | identity == "Lynn" )

###model
model.3poly = lm(no.shoots ~ no.sites + identity + no.discs, data=mg.fall2017.6month.den.Poly3)
anova(model.3poly) #no.discs --> significant; no.sites marginally significant
